...
for ( j = 0 ; j < npart ; ++ j ){	
    ...
    if ( innerRadius &&
              ...
              (zind>0.) && (zind<wallHeight-0.5) ){
        particles.push_back({1.0,1.0,{scaledX+cylCenterY, scaledY+cylCenterY, zind+bufferLen},{0., 0., 0.},0});
        pCount++;
        pCountWall++;
    }
    else if ( innerRadius && middleInRadius && (zind>wallHeight-0.5) && (zind<wallHeight) ){
        particles.push_back({1.0,1.0,{scaledX+cylCenterY, scaledY+cylCenterY, zind+bufferLen},{0., 0., 0.},0});
        pCount++;
        pCountWall++;
    }
            ...
            (scaledX > -0.5*boxEdge[x]) && (scaledX < 0.5*boxEdge[x]) &&
            (scaledY > -0.5*boxEdge[y]) && (scaledY < 0.5*boxEdge[y]) &&  
            (zind>wallHeight-0.5) && (zind<wallHeight) ){
        particles.push_back({1.0,1.0,{scaledX+cylCenterY, scaledY+cylCenterY, zind+bufferLen},{0., 0., 0.},3});
        pCount++;
        pCountWall++;
    }
    // cylinder
    else if ( innerRadius && middleInRadius && (zind>wallHeight) && (zind < capLen+wallHeight) ){
        particles.push_back({1.0,1.0,{scaledX+cylCenterX, scaledY+cylCenterY, zind+bufferLen},{0., 0., 0.},0});
        pCount++;
        pCountCyl++;
    }
    else if (middleOutRadius && outerRadius && (zind>wallHeight) && (zind < capLen+wallHeight)  ){
        particles.push_back({1.0,1.0,{scaledX+cylCenterY, scaledY+cylCenterY, zind+bufferLen},{0., 0., 0.},3});
        pCount++;
        pCountCyl++;
    }
    //upper wall
              ...
              (scaledX > -0.5*boxEdge[x]) && (scaledX < 0.5*boxEdge[x]) &&
              (scaledY > -0.5*boxEdge[y]) && (scaledY < 0.5*boxEdge[y]) &&            
              (zind>capLen+wallHeight+0.5) && (zind<capLen+2*wallHeight) ){
        particles.push_back({1.0,1.0,{scaledX+cylCenterY, scaledY+cylCenterY, zind+bufferLen},{0., 0., 0.},0});
        pCount++;
        pCountWall++;
    }
    else if ( innerRadius && middleInRadius && (zind>capLen+wallHeight) && (zind<capLen+wallHeight+0.5) ){
        particles.push_back({1.0,1.0,{scaledX+cylCenterY, scaledY+cylCenterY, zind+bufferLen},{0., 0., 0.},0});
        pCount++;
        pCountWall++;
    }
            ...
            (scaledX > -0.5*boxEdge[x]) && (scaledX < 0.5*boxEdge[x]) &&
            (scaledY > -0.5*boxEdge[y]) && (scaledY < 0.5*boxEdge[y]) &&  
            (zind>capLen+wallHeight) && (zind<capLen+wallHeight+0.5) ){
        particles.push_back({1.0,1.0,{scaledX+cylCenterY, scaledY+cylCenterY, zind+bufferLen},{0., 0., 0.},3});
        pCount++;
        pCountWall++;
    }
...
simProg << "Number density of particles in wall is =" << pCountWall/(2*wallVol) << "\n\n"; 
