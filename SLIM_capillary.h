...
simProg << "***************************************************" << std::endl;
simProg << "Started initialization of the SLIM capillary setup" << std::endl;
...
for ( j = 1 ; j <= npart ; ++ j ){	
    ...
    if ( type == 'O' )
        particles.push_back( {1.0 ,1.0 , {xind , yind , zind + 20. } ,{rand_gen_velx, rand_gen_vely, rand_gen_velz}, 0} );
    else if ( type == 'H' )
        particles.push_back( {1.0 ,1.0 , {xind , yind , zind + 20. } ,{rand_gen_velx, rand_gen_vely, rand_gen_velz}, 1} );
    else if ( type == 'C' )
        particles.push_back( {1.0 ,1.0 , {xind , yind , zind + 20. } ,{rand_gen_velx, rand_gen_vely, rand_gen_velz}, 2} );
    else if ( type == 'B' )
        particles.push_back( {1.0 ,1.0 , {xind , yind , zind + 20. } ,{rand_gen_velx, rand_gen_vely, rand_gen_velz}, 3} );
