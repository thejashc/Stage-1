...
capThick		= 2.;
 ...
 simProg << "***************************************************" << std::endl;
 simProg << "Started initialization of the wall-adjacent (below) to reservoir" << std::endl;
...
simProg << "***************************************************" << std::endl;
simProg << "Started initialization of the wall-adjacent (above) to reservoir" << std::endl;
